...
# the client2 user has only selection and update privileges on the project2 and
bikdeb database schemas.
...
select ridername
from racewinners
where racename = 'World Cyclocross Championships - Elite Women' and raceyear =
2020;
...
# Update rider Annemeik van Vleuten to show number of wins = 210 in the riders
table.
